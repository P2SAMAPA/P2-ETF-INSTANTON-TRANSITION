...
OUTPUT_REPO = "P2SAMAPA/p2-etf-instanton-transition-results"
...
N_MINIMA = 3                # number of local minima in effective potential
BARRIER_SCALE = 0.5         # scale of potential barrier
TOP_N = 3
